...
class WorktimeSchedule():
    ...
    def _generate_solutions(cls, period, doms):
        ...
        The problem takes a mapping, doms, from child_pk to a set of assignables for that child, plus a specification, across children, of which assignables are consistent
